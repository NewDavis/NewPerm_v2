...
public class PlayerPermissionMenu {

    public static HashMap<Player, Integer> playerPermPage = new HashMap<>();

    public static void openPermissionMenu(Player p, OfflinePlayer t, int page) {
        ...
        if(page != 0) {
            ...
            if (pages >= page) {
                Inventory inventory = Bukkit.createInventory(null, 9 * 5, "§7" + t.getName() + " §8● §cPerm");
